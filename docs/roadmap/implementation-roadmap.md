...
- Stage 6D1 - Trusted Image Publication Engine & Contracts: complete / merged; establishes local trusted-publication naming, candidate and authoritative reference construction, digest continuity validation, same-source rerun protection, publication evidence validation, and a Stage 5-compatible `image-reference.json` handoff without registry mutation.
- Trusted Publication Boundary Hardening: complete / merged; locked attempt-aware candidate identity, rerun identity checks, and authoritative-only handoff boundaries before the live GHCR visibility proof retired private candidate quarantine.
- Stage 6D2 - Trusted GHCR Workflow & First Live Publication: complete / live-proven; successful run `32476158117` attempt `1` on protected `main` source `398d171e6331c2d1c8cea307a7ae725cd47a1e51` performed one application build, verified public candidate staging, protected `authoritative-publication` Environment approval, authenticated authoritative recheck, digest-pinned no-rebuild promotion, anonymous authoritative verification, validated authoritative evidence, and Stage 5 handoff for digest `sha256:11b7fc3a664eec61aa5833389deeba0e3f99f7ecbdeaa4aa817199bfc50f2b4a`.
- Stage 6D - Trusted OCI Publication & Immutable Digest: complete / live-proven for the representative fixture; candidate and authoritative trust roles, scanner evidence provenance, digest continuity, mutable-tag avoidance, historical partial-artifact classification, and authoritative Stage 5 digest handoff are documented.
