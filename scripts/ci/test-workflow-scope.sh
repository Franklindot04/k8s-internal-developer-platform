...
trusted_publication_workflow_change=".github/workflows/trusted-image-publication.yml"
trusted_publication_runtime_change="scripts/supply-chain/trusted-publication.sh"
trusted_publication_engine_change="scripts/supply-chain/publication.rb"
trusted_publication_validator_change="scripts/supply-chain/validate-publication.rb"
...
assert_scope "unrelated documentation" trusted-publication false "$unrelated_docs"
...
assert_scope "trusted publication workflow" trusted-publication true "$trusted_publication_workflow_change"
assert_scope "trusted publication runtime" trusted-publication true "$trusted_publication_runtime_change"
assert_scope "trusted publication engine" trusted-publication true "$trusted_publication_engine_change"
assert_scope "trusted publication validator" trusted-publication true "$trusted_publication_validator_change"
assert_scope "trusted publication fixture Dockerfile" trusted-publication true "$supply_chain_fixture_dockerfile_change"
assert_scope "trusted publication policy fixture" trusted-publication true "$supply_chain_policy_fixture_change"
assert_scope "trusted publication tooling metadata" trusted-publication true "scripts/supply-chain/versions.env"
assert_scope "trusted publication shared Makefile" trusted-publication true "$makefile_change"
assert_scope "trusted publication shared classifier" trusted-publication true "$scope_change"
assert_scope "trusted publication governance validator" trusted-publication true "$workflow_governance_change"
