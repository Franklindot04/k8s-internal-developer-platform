...
run "Test trusted publication contracts" ruby scripts/supply-chain/test-publication.rb
run "Test trusted publication workflow runtime" ruby scripts/supply-chain/test-trusted-publication-workflow.rb
